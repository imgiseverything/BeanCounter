...
<hr />
<p><a href="<?php echo $objProject->getFolder() . $properties['project_id']; ?>/">Cancel</a></p>
...
<h2>Your options</h2>
<ul class="options">
	<li><a href="<?php echo $objProject->getFolder() . $properties['project_id']; ?>/">View <?php echo stripslashes($properties['project_title']); ?></a></li>
