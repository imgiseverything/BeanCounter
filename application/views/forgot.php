...
?>
	<div id="PrimaryContent">
        ...
        <form id="forgotForm" action="/forgot/" method="post">
            <fieldset>
	            <p class="instructions">In order to maintain security, all our passwords are encrypted. This means we'll have to email you a new <strong>randomly generated</strong> password if you have forgotten yours. You can change this new password the next time you login.</p>
	            <div class="field">
	           		<label for="email">Email address</label>
	            	<input type="email" value="<?php echo $objAuthorise->getEmail(); ?>" name="email" id="email" />
	            </div>
	            <input type="hidden" name="forward" value="<?php echo $objApplication->getParameter('url'); ?>" />
	            <input type="hidden" name="action" value="forgot" />
	            <button name="submit" type="submit" class="secure">Send me a new password</button>
            </fieldset>
        </form>
