	...
	<form id="filterForm" method="get" action="<?php echo $objScaffold->getFolder(); ?>" class="hidden">
    	<fieldset>
    		<fieldset class="fieldset-row">
    			<div class="field">
	    			<label for="outgoing_category">Choose a category:</label>
	                <select name="category" id="outgoing_category">
	                	<?php echo drawDropDown(getDropDownOptions('outgoing_category', 'Choose'), $objScaffold->getCategory()); ?>
	                </select>
	            </div>
    			<div class="field">
	    			<label for="supplier">Choose a supplier:</label>
	                <select name="supplier" id="supplier">
	                	<?php echo drawDropDown(getDropDownOptions('outgoing_supplier', 'Choose'), $objScaffold->getSupplier()); ?>
	                </select>
	            </div>
    		</fieldset>
        	<fieldset class="fieldset-row">
