<?php
	...
	/**
	 *	Timings Tags Controller
	 *  View all or individual timing tags and add/edit/delete them
	 */
	...
	// Initialise Object
	$objScaffold = new TimingTag($db, $objApplication->getFilters(), $objApplication->getId());
