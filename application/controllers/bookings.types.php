<?php
	...
	/**
	 *	Bookings Types Controller
	 *  View all or individual bookings types and add/edit/delete them
	 */
	...
	// Initialise Object
	$objScaffold = new BookingType($db, $objApplication->getFilters(), $objApplication->getId());
