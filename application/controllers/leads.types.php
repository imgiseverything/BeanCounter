<?php
	...
	/**
	 *	Leads Types Controller
	 *  View all or individual lead types and add/edit/delete them
	 */
	...
	// Initialise Object
	$objScaffold = new LeadType($db, $objApplication->getFilters(), $objApplication->getId());
