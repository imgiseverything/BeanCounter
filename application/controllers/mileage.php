<?php
	...
	/**
	 *	Mileage Controller
	 *  View all or individual mileage readings and add/edit/delete them
	 */
	...
	$objApplication->setFilter('category', 6);
	
	// Initialise Object
	$objScaffold = new Mileage($db, $objApplication->getFilters(), $objApplication->getId());
